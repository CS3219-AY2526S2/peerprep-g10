...
describe("MatchingService Unit Tests", () => {
  ...
  describe("executeMatch", () => {
    ...
    const ticketA: MatchTicket = { userId: "userA", socketId: "socketA", topic, difficulty, joinedAt: 1000 };
    const ticketB: MatchTicket = { userId: "userB", socketId: "socketB", topic, difficulty, joinedAt: 2000 };
