...
```bash
# Run schema
psql -U your_user -d peerprep -f src/database/init.sql

# Seed default admin (admin@peerprep.com / Admin123!)
psql -U your_user -d peerprep -f src/database/seed.sql
```
...
| `PATCH` | `/:id/ban` | JWT | Admin | Ban or unban a user |
